...
FROM products as p , images_tbl as i where p.id = i.product_id and (SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 1), ',', -1) = 'baby' or SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 2), ',', -1) = 'baby' or SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 3), ',', -1) = 'baby' or SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 4), ',', -1) = 'baby' OR SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 5), ',', -1) = 'baby' OR SUBSTRING_INDEX(SUBSTRING_INDEX(p.gender, ',', 6), ',', -1) = 'baby') ORDER by id DESC LIMIT 12");
